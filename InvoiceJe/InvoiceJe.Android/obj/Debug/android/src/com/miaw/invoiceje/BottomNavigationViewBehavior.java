...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("InvoiceJe.Droid.Extensions.BottomNavigationViewBehavior, InvoiceJe.Android, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", BottomNavigationViewBehavior.class, __md_methods);
	}


	public BottomNavigationViewBehavior () throws java.lang.Throwable
	{
		super ();
		if (getClass () == BottomNavigationViewBehavior.class)
			mono.android.TypeManager.Activate ("InvoiceJe.Droid.Extensions.BottomNavigationViewBehavior, InvoiceJe.Android, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}


	public BottomNavigationViewBehavior (android.content.Context p0, android.util.AttributeSet p1) throws java.lang.Throwable
	{
		super (p0, p1);
		if (getClass () == BottomNavigationViewBehavior.class)
			mono.android.TypeManager.Activate ("InvoiceJe.Droid.Extensions.BottomNavigationViewBehavior, InvoiceJe.Android, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "Android.Content.Context, Mono.Android, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065:Android.Util.IAttributeSet, Mono.Android, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", this, new java.lang.Object[] { p0, p1 });
	}
	...
	public boolean onLayoutChild (android.support.design.widget.CoordinatorLayout p0, android.view.View p1, int p2)
	{
		return n_onLayoutChild (p0, p1, p2);
	}

	private native boolean n_onLayoutChild (android.support.design.widget.CoordinatorLayout p0, android.view.View p1, int p2);
